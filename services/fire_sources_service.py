...
FIRE_DATA_SOURCES: Dict[str, Dict[str, object]] = {
    ...
    "nasa_gibs_hotspots": {
        ...
        "point_sources": [
            {
                "collections": ["NASA/LANCE/SNPP_VIIRS/C2"],
                "band": "frp",
                "rename": "NASA_GIBS_SNPP_VIIRS_FRP",
                "satellite": "NASA GIBS | VIIRS SNPP",
                "event_type": "Hotspot NASA GIBS VIIRS SNPP",
                "sample_scale": 375,
                "sample_limit": 5000,
                "vis": {"min": 0, "max": 80, "palette": ["#ffff00", "#ff7a00", "#ff0000", "#ffffff"]},
            },
            {
                "collections": ["NASA/LANCE/NOAA20_VIIRS/C2"],
                "band": "frp",
                "rename": "NASA_GIBS_NOAA20_VIIRS_FRP",
                "satellite": "NASA GIBS | VIIRS NOAA-20",
                "event_type": "Hotspot NASA GIBS VIIRS NOAA-20",
                "sample_scale": 375,
                "sample_limit": 5000,
                "vis": {"min": 0, "max": 80, "palette": ["#ffff00", "#ff7a00", "#ff0000", "#ffffff"]},
            },
